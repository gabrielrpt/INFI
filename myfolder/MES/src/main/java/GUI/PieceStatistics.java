 ...
 * @author gabri
 */
public class PieceStatistics extends javax.swing.JFrame {

    /**
     * Creates new form PieceStatistics
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Piece Statistics");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(332, 33, 260, 36);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PieceStatistics.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PieceStatistics().setVisible(true);
            }
        });
    }
